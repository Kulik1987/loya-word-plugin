...
const fakeResponseAPI: ContractRecommendationResponseT[] = [
  {
    ...
    partContract:
      "Принципал поручает Агенту, а Агент обязуется на основании выдаваемой Принципалом доверенности за вознаграждение совершать от имени и за счет Принципала юридические и фактические действия (исполнять агентские поручения), предусмотренные Приложением №1 к настоящему Договору в соответствии с Регламентом взаимодействия Сторон (Приложение №3 к настоящему Договору).",
    partModified:
      "Принципал поручает Агенту, а Агент обязуется на основании выдаваемой Принципалом доверенности за вознаграждение совершать от имени и за счет Принципала юридические и фактические действия (исполнять агентские поручения), предусмотренные Приложением №1 к настоящему Договору в соответствии с Регламентом взаимодействия Сторон (Приложение №3 к настоящему Договору), при условии, что такие поручения не противоречат законодательству Российской Федерации.",
    comment:
